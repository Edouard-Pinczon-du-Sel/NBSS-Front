  ...
  return (
    <div className="contact--page">
      ...
      <div className="contact--page__container--data">
        <span className="contact--page__email"><p className="contact--page__label--data">E-mail de l'entreprise :</p><a href="mailto:nbservicesetsoins@gmail.com">nbservicesetsoins@gmail.com</a></span>
        <span className="contact--page__phone"><p className="contact--page__label--data">Numéro de téléphone :</p><a href="tel:+336 25 59 18 11">06 25 59 18 11</a> &#40;joignable du lundi au vendredi de 9:00 à 18:00 et le samedi de 9h30 à 12h30&#41;</span>
